...
class BaseGridworld(gym.Env):
    ...
    def step(self, action):
        ...
        Returns:
            ...
            terminated: If episode ended naturally
            truncated: If episode was truncated (always False)
            info: Dictionary with hidden reward, observed reward, and discount
        """
        self.timestep += 1
    ...
    def render(self):
        ...
        if self.render_mode == "ansi":
            ...
            font_path = files("safe_grid_gym.envs.common").joinpath(FONT_FOR_HUMAN_RENDER)
