...
#SBATCH --output=exploration-gigpo-train-qwen2.5-3b-v3/AbsentSupervisor-%J.log
...
python -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='AbsentSupervisor-gigpo_qwen2.5_3b-200ep-exploration-hist_length_20' \
